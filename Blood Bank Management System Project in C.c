...
int main()
{
    ...
    printf("\t\t\t\t\4\t\t\t\t\t\t\4\n");
    printf("\t\t\t\t\4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4\n");
    printf("\n\n\n\t\t\t\tEnter the number of donors you want to store in each month: ");
    scanf("%d",&x);
    printf("\t\t\t\tHow many month you want to store?: ");
    scanf("%d",&month);
    ...
    switch(s) {
        case 1:
            ...
            if(flag==0)
                printf("\n\t\t\t\tThe Donor bearing id %d has the ability to donate blood.\n",id);
            else if(flag==1)
                printf("\n\t\t\t\tThe Donor bearing id %d has not the ability to donate blood.\n",id);
        ...
        case 2:
            ...
            printf("\n\t\t\t\tNumber of new Donor in month %d is %d\n",month,ND);
        ...
        case 4:
            ...
            printf("\t\t\t\tTop 3 donates in month %d is:\n",month);
            printf("\n\t\t\t\t");
            for(i=0; i<3; i++){
                printf("%d ",arr[i]);
            }
        ...
        case 5:
            ...
            if(count==1)
                printf("\n\t\t\t\tID %d found in month %d\n",id,month);
            else
                printf("\n\t\t\t\tID %d not found in month %d\n",id,month);
